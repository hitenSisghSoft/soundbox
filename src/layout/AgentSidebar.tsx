...
const AgentSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ['main', 'others'].forEach((menuType) => {
      const items = menuType === 'main' ? menuItems : [];
  ...
  const renderMenuItems = (navItems: typeof menuItems, menuType: 'main' | 'others') => (
      ...
      >
        <Link href="/agent">
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            <Image src="/images/logo/logo.svg" alt="Logo" width={32} height={32} />
          )}
        </Link>
      </div>
