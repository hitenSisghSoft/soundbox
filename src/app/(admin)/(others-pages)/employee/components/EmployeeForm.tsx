...
const rolesOption = [{value: "agent", label: "Agent"}, {value: "operations", label: "Operations"},{value: "support", label: "Support"}];
const shiftOption = [{value: "morning", label: "Morning"}, {value: "evening", label: "Evening"},{value: "night", label: "Night"}];
const EmployeeValidation = yup.object().shape({
  name: yup.string().required("Name is required *"),
  email: yup.string().email("Invalid Email").required("Email is required *"),
  mobile: yup.string().required("Mobile is required *").max(10, "Mobile number can't be more than 10 digits").min(10, "Mobile number must be at least 10 digits"),
  ...
  return (
    ...
    handleSubmit(onSubmitHandler)(e);
            ...
            //   onSubmit={handleSubmit(onSubmitHandler)}
              ...
              // noValidate
            >
              <h2 className="text-white mb-2">Add User</h2>
              <Input
                type="text"
                id="input"
